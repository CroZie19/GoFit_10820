...
class TransaksiDepositUangController extends Controller
{
    ...
    {
        $transaksi_deposit_uang = Transaksi_Deposit_Uang::Join('member', 'transaksi__aktivasi__tahunan.id_member','=','member.id')
    ...
    public function showList(){
        try{
            $transaksi_aktivasi_tahunan = Transaksi_Deposit_Uang::get();
    ...
    public function show(int $id){
        try{
            $transaksi_aktivasi_tahunan = Transaksi_Deposit_Uang::find($id);
            $transaksi_aktivasi_tahunan = Transaksi_Deposit_Uang::Join('jadwal_harian', 'transaksi__perijinan__instrukturs.id_jadwal_harian','=','jadwal_harian.id')
